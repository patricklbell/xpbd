...
typedef void(*PHYS_DBG_DrawEdgeBatch)(vec3_f32* edges, vec3_f32* colors, u32 edge_count);
typedef void(*PHYS_DBG_DrawPointBatch)(vec3_f32* points, vec4_f32* colors, f32* radii, u32 point_count);
